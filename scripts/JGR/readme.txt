...
#Main Workflow to be followed for tsunami emulation 
...
4. Script main.py is used to train and test the machine learning models. The models are trained on the data prepared in the previous step. The models and predictions are saved in /models/<region>/<task>.
