...
def config():
    ...
    #for evaluation
    threshold = 0.1 #threshold for flooded or not in evaluation
...
class BuildTsunamiAE():
    ...
    def finetuneAE(self,
            ...
            batch_size_on, #batch size onshore
            nepochs,
            lr_couple,
    ...
    def evaluateAE(self,
        ...
        plt.suptitle(f"mseoverall: {mseoverall:.5f},r2maxdepth: {r2maxdepth:.5f}_testsize: {self.test_size}",fontsize=25)
