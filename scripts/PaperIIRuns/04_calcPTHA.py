...
if mode == 'PTHA':
    ...
    eve_SIS = pd.read_csv(f'{MLDir}/model/{reg}/PTHA/eve_SIS_{reg}.txt')
    ...
    np.save(f'{MLDir}/model/{reg}/PTHA/true_d_{train_size}.npy',true_d)
    ...
    for select_pt in range(50000): #nflood_grids
    ...
    #save RP tables
    np.save(f'{MLDir}/model/{reg}/PTHA/true_RP_{train_size}.npy',RP_table_true)
