...
figurepng = "MIH_histogram_cumulative_percentage.png"
figurepdf = "MIH_histogram_cumulative_percentage.pdf"
...
bins  = np.arange( 0.0, 11.5, 1.0)
# bins  = np.arange( 0.0, 11.5, 0.25)
