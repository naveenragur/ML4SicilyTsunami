...
np.save(f'./pred_d_dask_{size}.npy', pred_d_dask_filtered)
...
#save the flat files
np.save(f'./event_id_pred_{size}.npy', event_id_dask_filtered)
...
#save the flat files
np.save(f'./site_id_pred_{size}.npy', site_id_dask_filtered)
