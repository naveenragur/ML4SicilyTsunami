...
np.save(OUTPUT_DIR / f'pred_d_dask_{size}_sigmaplus.npy', pred_d_dask_filtered)
...
#save the flat files
np.save(OUTPUT_DIR / f'event_id_pred_{size}_sigmaplus.npy', event_id_dask_filtered)
...
#save the flat files
np.save(OUTPUT_DIR / f'site_id_pred_{size}_sigmaplus.npy', site_id_dask_filtered)
