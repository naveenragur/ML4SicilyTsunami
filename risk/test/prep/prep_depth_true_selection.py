...
sel_events = [33230,33710,43022,3550,30117,14789,43773,532,8590,29875]
true_d = np.load('/mnt/beegfs/nragu/tsunami/ML4SicilyTsunami/model/CT/PTHA/true_d_53550.npy')[sel_events,:]
num_events, num_sites = true_d.shape
print(num_events, num_sites)
